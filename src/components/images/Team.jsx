...
const Team = ({ className, color = "#6691FF" }) => {
    return (
        <svg className={className} width="39" height="40" viewBox="0 0 39 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M10.761 24.3893C8.35925 24.8032 5.71212 24.3713 3.85387 23.0935C1.38204 21.4017 1.38204 18.63 3.85387 16.9382C5.72965 15.6604 8.41185 15.2285 10.8135 15.6604" stroke={color} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M19.5267 24.7311C19.4215 24.7131 19.2988 24.7131 19.1936 24.7311C16.7744 24.6411 14.8459 22.6074 14.8459 20.0877C14.8459 17.514 16.862 15.4442 19.3689 15.4442C21.8758 15.4442 23.8918 17.532 23.8918 20.0877C23.8743 22.6074 21.9459 24.6591 19.5267 24.7311Z" stroke={color} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M14.4247 30.4004C11.9528 32.0922 11.9528 34.8639 14.4247 36.5557C17.2296 38.4814 21.8227 38.4814 24.6276 36.5557C27.0994 34.8639 27.0994 32.0922 24.6276 30.4004C21.8402 28.4927 17.2296 28.4927 14.4247 30.4004Z" stroke={color} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
